    ...
    internal class ProductSeed : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            builder.HasData(
                ...
                new Product { Id = 4, CategoryId = 2, Name = "Kitap 1", Price = 700, Stock = 70, CreatedDate = DateTime.Now },
                new Product { Id = 5, CategoryId = 2, Name = "Kitap 2", Price = 600, Stock = 320, CreatedDate = DateTime.Now }
                );
        }
    }
}
